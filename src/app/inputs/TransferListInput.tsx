...
import { Container, Typography, Grid, Paper, Button, List, ListItemButton, ListItemIcon, ListItemText, Checkbox } from '@mui/material';
...
export default function TransferListInput() {
        ...
        {items.map((value: number) => {
          ...
          return (
            <ListItemButton key={value} role="listitem" onClick={handleToggle(value)}>
              <ListItemIcon>
                <Checkbox checked={checked.includes(value)} tabIndex={-1} disableRipple inputProps={{ 'aria-labelledby': labelId }} />
              </ListItemIcon>
